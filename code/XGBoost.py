...
def run_tfidf_xgboost(save_results=True):
    ...
    if save_results:
        ...
        metrics_df.to_csv("results/csv/xgboost_results.csv", index=False)

        joblib.dump(model, "models/xgboost_model.pkl")

        print("\n[SAVED] results/csv/xgboost_results.csv")
...
def plot_all_results(model, y_test, y_pred, y_pred_proba, save_dir="results/figures"):
